...
export type SendRequestSuccessPayload = {
  type: string;
  response: GrpCurlResponse;
};

export type SendRequestFailurePayload = {
  type: string;
  response: GrpCurlResponse;
};
...
export type UpdateBodySuccessPayload = {
  type: string;
};
...
export const sendRequestSuccess = (response: GrpCurlResponse): SendRequestSuccessPayload => ({
  type: REQUEST_SEND_SUCCESS,
  response,
});

export const sendRequestFailure = (response: GrpCurlResponse): SendRequestFailurePayload => ({
...
export const updateBodySuccess = (): UpdateBodySuccessPayload => ({
