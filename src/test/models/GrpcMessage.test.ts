...
const errorMessage = new GrpcMessage(new GrpCurlResponse(
    '/grpcurl -plaintext -max-time 5 localhost:9999 describe com.delivery.v1.messages.AnonymousUser',
    'I have errored',''));

const fieldMaskMessage = new GrpcMessage((new GrpCurlResponse('', '', `
...
const entityTypeMessage = new GrpcMessage((new GrpCurlResponse('/grpcurl -plaintext -max-time 5 localhost:9999 describe com.delivery.v1.messages.EntityType', 'I errored', '')));

const registeredUserMessage = new GrpcMessage((new GrpCurlResponse('', '', `
...
const paginationRequestMessage = new GrpcMessage((new GrpCurlResponse('', '', `
...
const pageMessage = new GrpcMessage((new GrpCurlResponse('', '', `
...
const countryMessage = new GrpcMessage((new GrpCurlResponse('', '', `
